		...
		<footer id="footer" class="footer">
				...
				<div class="col_one_third col_last">
					...
					<div class="widget clearfix">
						...
						<ul class="nobottommargin nobullets">
							...
							<br>
							<li><strong>객실예약(주중)안내.</strong><br>전화예약 09:00 ~ 18:00</li>
							<p>
								온라인예약 00:00 ~ 24:00<br>
			...
			<div id="copyrights">
				<div class="container clearfix">
					...
					<div class="col_half">
						<img src="<c:url value='/resources/images/logo/footer-logo.png'/>"
							alt="" class="footer-logo standard-logo"> <img
