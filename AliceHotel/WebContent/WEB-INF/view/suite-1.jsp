...
<head>
    ...
    <!-- Document Title
    ============================================= -->
	<title>Ailce Hotel | Room - Family Suite</title>
                              ...
                              <c:choose>
                               ...
                               <div class="slide"><a href="<c:url value="resources/images/logo/room-12.PNG"/>" data-lightbox="gallery-item"><img class="image_fade" src="<c:url value="resources/images/logo/room-12.PNG"/>" alt=""></a></div>
								...
								<hr style="border: solid 1px navy;">
                                    ...
                                    &middot; 요청시 기능성 베개 제공<br>
                                    &middot; 전 객실 초고속 무료 인터넷 (유선, 와이파이)
									<hr style="border: solid 1px navy;">
                              		<h3>어메니티</h3><p> 
                                    <h6>일반 : 60" LED TV / 발코니 / 손전등 / 금고 / 사무용 데스크 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 욕실 : 월풀(야쿠지) / 욕실용품(몰튼브라운) / 비데 / 면도기 / 목욕 가운 / 헤어드라이어<br>
                                    기타 : 케이블,위성 TV채널 / 무료 생수 1일 4병 / 무료 차(Tea) 서비스 제공</h6>
                                    <hr style="border: solid 1px navy;">
