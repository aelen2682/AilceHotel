                ...
                <div id="contact-form-overlay" class="clearfix bgcolor-grey">
                 ...
                 var Check = false;
					...
					<div class="row">
						...
						<input type="text" class="well well-sm" name="userId" id="m_id" size="85" placeholder="ID" required="required" maxlength="12">
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<br>
							<input type="password" class="well well-sm" name="password" id="m_password2" size="85" placeholder="Password Check" required="required" maxlength="15"> 
						</div> 
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<input type="text" class="well well-sm" name="homeMail" id="sample2_postcode" size="35" placeholder="ex) 19xxx"  readonly="readonly">
						</div>

						<div class="col-md-6">
							<label for="template-contactform-name">기본주소</label><br>
							 <input type="text" class="well well-sm" name="generalAddress" id="sample2_address" size="35" placeholder="기본주소"  required="required">
						</div>
					</div>
					...
					<div class="col-md-6">
						...
						<div class="col-md-6">
							...
							<input type="text" class="well well-sm" name="detailedAddress" id="sample2_detailAddress" size="35" placeholder="상세주소" required="required">
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<input type="text" class="well well-sm" name="name" id="" size="35" placeholder="Name" required="required">
						</div>

						<div class="col-md-6">
							<label for="template-contactform-name">전화번호</label><br>
							 <input type="text" class="well well-sm" name="phone" id="" size="35" placeholder="Tel" required="required">
						</div>
					</div>
						  ...
						  <div class="col_full">
							...
							<br>
							<input type="email" class="well well-sm" name="email" id="m_userEmail" size="85"  placeholder="Email" required="required">
					 </div>
