...
<head>
    ...
    <!-- Document Title
    ============================================= -->
	<title>Ailce Hotel | Room - Grand Suite</title>
...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="page-title" class="page-title-parallax" style="background-image: url('<c:url value="/resources/images/logo/room.PNG"/>'); padding: 120px 0;" data-stellar-background-ratio="0.3">
            ...
            <div class="container clearfix">
                <FONT SIZE="6" COLOR="white">Ailce Hotel | Suite Room</span></FONT>
                <ol class="breadcrumb">
                </ol>
            </div>
                        ...
                        <div class="nobottommargin">
                           ...
                           <c:choose>
                               ...
                               <div class="entry clearfix">
                                ...
                                <div class="slide"><a href="<c:url value="resources/images/logo/room-13.PNG"/>" data-lightbox="gallery-item"><img class="image_fade" src="<c:url value="resources/images/logo/room-13.PNG"/>" alt=""></a></div>
                               <div class="slide"><a href="<c:url value="resources/images/logo/room-14.PNG"/>" data-lightbox="gallery-item"><img class="image_fade" src="<c:url value="resources/images/logo/room-14.PNG"/>" alt=""></a></div>
                               <div class="slide"><a href="<c:url value="resources/images/logo/room-15.PNG"/>" data-lightbox="gallery-item"><img class="image_fade" src="<c:url value="resources/images/logo/room-15.PNG"/>" alt=""></a></div>
                               <div class="slide"><a href="<c:url value="resources/images/logo/room-16.PNG"/>" data-lightbox="gallery-item"><img class="image_fade" src="<c:url value="resources/images/logo/room-16.PNG"/>" alt=""></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>                 
                                ...
                                <div class="topmargin-sm">
                                    ...
                                    <h3>객실개요</h3><p> 
                                    침대 타입 : 더블침대 2개 + 싱글침대 1개 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 체크인/체크아웃 : 14:00 / 11:00<br>
                                    최대 수용인원 : 5명 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 전망 : 오션 뷰
									<hr style="border: solid 1px navy;">
                              		<h3>서비스</h3><p> 
                                    <&middot; 제주도의 아름다운 자연 전망(오션 뷰)<p>
									...
									<hr style="border: solid 1px navy;">
                              		<h3>어메니티</h3><p> 
                                    일반 : 75" LED TV / 발코니 / 손전등 / 금고 / 사무용 데스크 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 욕실 : 욕실용품(몰튼브라운) / 비데 / 면도기 / 목욕 가운 / 헤어드라이어<br>
