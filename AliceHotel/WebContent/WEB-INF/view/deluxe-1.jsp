...
<head>
    ...
    <!-- Document Title
    ============================================= -->
	<title>Ailce Hotel | Room - Deluxe Double</title>
   ...
   <!-- Logo
                    ...
                    ============================================= -->
                     <nav id="primary-menu">
                        ...
                        <ul class="">
                            <li class><a href="<c:url value="/hotel-About-Us"/>"><div>호텔소개</div></a>
                                        <ul>                                
        ...
        <section id="page-title" class="page-title-parallax" style="background-image: url('<c:url value="/resources/images/logo/room.PNG"/>'); padding: 120px 0;" data-stellar-background-ratio="0.3">
            ...
            <div class="container clearfix">
                <FONT SIZE="6" COLOR="white">Ailce Hotel | Deluxe Room</span></FONT>
                <ol class="breadcrumb">
                </ol>
            </div>
                                    ...
                                    <div class="fslider" data-arrows="false" data-lightbox="gallery">
                                        <div class="flexslider">
                                            <div class="slider-wrap">
                                                <div class="slide"><a href="<c:url value="/resources/images/logo/room-1.PNG"/>" data-lightbox="gallery-item"><img class="image_fade" src="<c:url value="/resources/images/logo/room-1.PNG"/>" alt=""></a></div>
                                                <div class="slide"><a href="<c:url value="/resources/images/logo/room-2.PNG"/>" data-lightbox="gallery-item"><img class="image_fade" src="<c:url value="/resources/images/logo/room-2.PNG"/>" alt=""></a></div>
                                                <div class="slide"><a href="<c:url value="/resources/images/logo/room-3.PNG"/>" data-lightbox="gallery-item"><img class="image_fade" src="<c:url value="/resources/images/logo/room-3.PNG"/>" alt=""></a></div>
                                                <div class="slide"><a href="<c:url value="/resources/images/logo/room-4.PNG"/>" data-lightbox="gallery-item"><img class="image_fade" src="<c:url value="/resources/images/logo/room-4.PNG"/>" alt=""></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>                 
